...
async function runTests() {
    ...
    const server = app_1.default.listen(PORT, async () => {
        ...
        try {
            ...
            await db_1.pool.query('TRUNCATE TABLE issues, users RESTART IDENTITY CASCADE;');
            // 2. Test Signup
            ...
            const dataSignupContr = await resSignupContr.json();
            ...
            const dataSignupMaint = await resSignupMaint.json();
            ...
            const dataLoginContr = await resLoginContr.json();
            ...
            const dataLoginMaint = await resLoginMaint.json();
            ...
            const dataCreateBug = await resCreateBug.json();
            ...
            const dataCreateFeat = await resCreateFeat.json();
            ...
            const dataGetIssues = await resGetIssues.json();
            ...
            const dataUpdateOwn = await resUpdateOwn.json();
            ...
            const dataUpdateStatusMaint = await resUpdateStatusMaint.json();
            ...
            const dataDeleteMaint = await resDeleteMaint.json();
            ...
            const dataGetAfterDelete = await resGetAfterDelete.json();
